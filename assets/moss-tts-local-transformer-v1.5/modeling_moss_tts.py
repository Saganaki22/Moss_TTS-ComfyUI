...
class MossTTSLocalModel(MossTTSLocalPreTrainedModel):
    ...
    def generate(
        ...
        progress_description: str = "MOSS-TTS generate",
        **kwargs,
        ...
        try:
            for frame_index in range(frame_budget):
                if progress_callback is not None and (frame_index == 0 or frame_index % 8 == 0):
                    progress_callback(frame_index, frame_budget)
                ...
                if progress_callback is not None and (
                    completed_frames == frame_budget or completed_frames % 8 == 0
                ):
                    progress_callback(completed_frames, frame_budget)
            ...
            if progress_callback is not None:
                progress_callback(frame_budget, frame_budget)
